<?php
    ...
    $selectAll = $newObj->selectAllPosting();
        ...
        while($rowAll = $selectAll->fetch()){
            ...
            <div class="post-head">
                <div class="post-head-lf">
                    ...
                    if($rowAll['active_status'] == "Online"){
                        echo '<span class="span-greened"></span>';
                    }
                    else{
                    ...
                    echo '<div class="name-post">
                        ...
                        <p>@'.$rowAll['username'].'</p>
                        <label><i class="fa fa-regular fa-clock"></i> '.$newObj->time_agoF($rowAll['time_post']).'</label>
                    </div>
                </div>
